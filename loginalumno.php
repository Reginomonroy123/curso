...
<body class="cover" style="background-image: url(./assets/img/login.png);">
	...
	<form  method="POST"  autocomplete="off" class="full-box logInForm">
		...
		<div class="form-group label-floating">
		  ...
		  <input class="form-control" name="correo" id="correo" type="email" style="width:280px;height:50px;font-size:12pt;color:white" >
		...
		<div class="form-group label-floating">
		  ...
		  <input class="form-control"  name="pass"  id="pass" type="password"  style="width:280px;height:50px;font-size:12pt;color:white">
...
if(isset($_POST['btn9'])  )
{
			...
			$pass = $_SESSION['pass'];
	$consulta =  "SELECT correo,pass FROM alumnos WHERE correo = '$correo' AND pass = '$pass' LIMIT 1";  
